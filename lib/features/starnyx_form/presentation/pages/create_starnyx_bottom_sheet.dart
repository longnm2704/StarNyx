...
Future<StarnyxFormResult?> showCreateStarnyxBottomSheet(
  BuildContext context, {
  String? initialColor,
}) {
  return showStarnyxFormBottomSheet(context, initialColor: initialColor);
}
...
class _StarnyxFormBottomSheetViewState
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<StarnyxFormBloc, StarnyxFormState>(
      builder: (BuildContext context, StarnyxFormState state) {
        final Color accentColor = starnyxColorFromHex(state.color);
              ...
              child: BlocListener<StarnyxFormBloc, StarnyxFormState>(
                ...
                child: Builder(
                  builder: (BuildContext context) {
                    ...
                    final formattedStartDate = core_date_utils
                        .DateUtils.formatDdMmYyyy(state.startDate);
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  StarnyxFormFieldLabel(
                                    label: 'starnyx_form.description_label'
                                        .tr(),
                                    trailing: _CharacterCounter(
                                      currentLength:
                                  ...
                                  StarnyxFormPillTextField(
                                    ...
                                    hintText: 'starnyx_form.description_hint'
                                        .tr(),
                                    maxLines: 5,
                                    height: 118,
                                    hasError: descriptionHasError,
                                  ...
                                  StarnyxFormColorCard(
                                    ...
                                    onColorSelected: (String colorHex) {
                                      bloc.add(
                                        StarnyxFormColorChanged(colorHex),
                                      );
                                    },
                                  ),
                                  const SizedBox(height: AppSpacing.lg),
                                  ...
                                  StarnyxFormReminderCard(
                                    ...
                                    label: 'starnyx_form.reminder_time_label'
                                        .tr(),
                                    onToggle: (bool enabled) {
                                      bloc.add(
                                        StarnyxFormReminderToggled(enabled),
                                      );
                                    },
